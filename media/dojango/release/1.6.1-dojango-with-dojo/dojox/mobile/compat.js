...
var _14=dojo.create("DIV",{className:"mblDummyForIE",innerHTML:"&nbsp;"},this.containerNode,"first");
dojo.style(_14,{position:"relative",marginBottom:"-2px",fontSize:"1px"});
}});
}
}
if(dojo.isIE<=6){
dojox.mobile.applyPngFilter=function(_15){
_15=_15||dojo.body();
var _16=_15.getElementsByTagName("IMG");
var _17=dojo.moduleUrl("dojo","resources/blank.gif");
...
dojox.mobile.loadCss=function(_18){
if(!dojo.global._loadedCss){
var obj={};
dojo.forEach(dojox.mobile.getCssPaths(),function(_19){
obj[_19]=true;
});
...
var _1a=_18[i];
if(!dojo.global._loadedCss[_1a]){
dojo.global._loadedCss[_1a]=true;
if(dojo.doc.createStyleSheet){
setTimeout(function(_1b){
return function(){
dojo.doc.createStyleSheet(_1b);
};
}(_1a),0);
}else{
var _1c=dojo.doc.createElement("link");
_1c.href=_1a;
_1c.type="text/css";
_1c.rel="stylesheet";
var _1d=dojo.doc.getElementsByTagName("head")[0];
_1d.appendChild(_1c);
}
}
}
...
var _1f=dojo.doc.getElementsByTagName("link");
for(i=0,len=_1f.length;i<len;i++){
if(_1f[i].href){
_1e.push(_1f[i].href);
}
}
...
var _20=dojox.mobile.getCssPaths();
for(var i=0;i<_20.length;i++){
var _21=_20[i];
if(_21.match(dojox.mobile.loadCompatPattern)&&_21.indexOf("-compat.css")==-1){
var _22=_21.substring(0,_21.length-4)+"-compat.css";
dojox.mobile.loadCss(_22);
}
}
};
