...
dojo.declare("tweetview.TweetView", [dojox.mobile.ScrollableView, tweetview._ViewMixin], {
	...
	// Icon for loading...
	iconLoading: "media/js/tweetview/resources/images/loading.gif",
	// iconLoading: "media/js/tweetview/resources/images/androidLoading.gif"
	...
	sortTweets: function(deflist) {
		...
		dojo.forEach(allTweets, function(tweet) {
			var time = new Date(tweet.created_at) - 0;
			indexedTweets[time] = tweet;
			timeArr.push(time);
		});
		timeArr.sort();
