...
if db_file:
    DATABASES = {
        'default': {
            ...
            'NAME': 'web_models.db', # Or path to database file if using sqlite3.
...
SECRET_KEY = 's3$@jn!+c)e^gbww)u$*n08c5(o#-=u1c=##6^7gys4uh70u34'
...
DOJANGO_BASE_MEDIA_ROOT="/app/media/dojango"
DOJANGO_BASE_DOJO_ROOT="/app/media/lib/dojo"
